Config.Locations = {
    ["Washing"] = {
        Enable = true,
        positions = {
            { name = "Stone Washing", coords = vec3(298.46, 3563.88, 30.16), sprite = 467, col = 3, disp = 6, blipEnable = true }, -- Mountains
            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, disp = 6, blipEnable = false },

            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, disp = 6, blipEnable = false }, -- Stream Blip
            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, blipEnable = false },
            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, blipEnable = false },
            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, blipEnable = false },

            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, disp = 6, blipEnable = false }, -- Gordo

            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, disp = 6, blipEnable = false }, -- Alamo Sea
            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, blipEnable = false },
            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, blipEnable = false },
            { name = "Stone Washing", coords = vec3(52.25, 3988.81, 789.82), sprite = 467, col = 3, blipEnable = false },
        },
    ...
    ["Mines"] = {
        ["Foundary"] = {
            ...
            Store = {
                { name = "Foundary Store", coords = vec4(1074.89, -1988.19, 1, 1), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
            },
            Smelting = {
        ...
        ["MineShaft"] = {
            ...
            Blip = {
                Enable = false,
                name = "Mine Shaft",
                coords = vec4(-1121.60, 4980.51, 186.17, 295.88),
                sprite = 527,
                col = 81,
            },
            Store = {
                { name = "Mine", coords = vec4(-1121.64, 4980.47, 1, 293.83), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
            },
            Lights = {
                Enable = true,
                prop = "prop_worklight_02a",
            ...
            OrePositions = {
                vector4(-1122.55, 4965.25, 186.49, 147.80),
                vec4(-1121.08, 4948.57, 185.74, 259.86),
                vec4(-1125.33, 4925.25, 183.99, 123.16),
                vec4(-1120.25, 4919.58, 183.37, 279.01),
                vec4(-1120.91, 4910.23, 183.01, 152.00),
                --DEEP
                vec4(-1114.98, 4896.23, 182.50, 130.22),
                vec4(-1111.45, 4881.08, 182.35, 134.74),
                vec4(-1106.37, 4858.41, 182.11, 204.53),
                vec4(-1109.51, 4843.53, 181.92, 194.29),
                vec4(-1112.22, 4825.00, 181.03, 229.31),
                vec4(-1118.66, 4799.04, 179.10, 199.02),
                vec4(-1131.70, 4785.24, 178.15, 184.79),
                vec4(-1119.62, 4780.02, 177.99, 258.50),
                vec4(-1112.35, 4768.10, 177.15, 198.39),
                vec4(-1087.24, 4758.62, 175.45, 166.42),
                vec4(-1081.24, 4760.71, 175.05, 351.68),
            },
        },
        ["Quarry"] = {
            Enable = true,
            ...
            Store = {
                { name = "Quarry", coords = vec4(2960.9, 2754.14, 1, 203.58), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
            },
            Lights = {
                Enable = true,
        ...
        ["K4MB1"] = { -- K4MB1's Mineshaft in the quarry
            ...
            Store = {
                { name = "Cave Shop", coords = vec4(2908.8, 2643.6, 1, 327.32), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
            },
            Smelting = {
