...
Config.Discord = {
    ...
    applicationId = '1245769601837432892',                   -- The discord application id
    iconLarge = 'logo_name',                               -- The name of the large icon
    iconLargeHoverText = 'Legends RolePlay', -- The hover text of the large icon
    iconSmall = 'logo_name',                         -- The name of the small icon
    iconSmallHoverText = 'Legends RolePlay', -- The hover text of the small icon
