...
Config = {
	...
	Jobs = {
		...
		-- ['bakery'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		   ['beanmachine'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0, },
		   ['galaxybar'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0, },
		   ['police'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0, },
		   ['ambulance'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0, },
		   ['advokat'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0, },
		   ['doj'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0, },
		   ['townhall'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0, },
