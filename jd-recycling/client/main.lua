    ...
    if Config.UseTarget then
        entranceZone = exports['qb-target']:AddBoxZone(entranceTargetID, coords, 1, 4, {
            ...
            options = {
                {
                    type = 'client',
                    event = 'jd-recycling:client:target:enterLocation',
    ...
    if Config.UseTarget then
        exitZone = exports['qb-target']:AddBoxZone(exitTargetID, coords, 1, 4, {
            ...
            options = {
                {
                    type = 'client',
                    event = 'jd-recycling:client:target:exitLocation',
    ...
    if Config.UseTarget then
        dutyZone = exports['qb-target']:AddBoxZone(dutyTargetID, coords, 1, 1, {
            ...
            options = {
                {
                    type = 'client',
                    event = 'jd-recycling:client:target:toggleDuty',
    ...
    if Config.UseTarget then
        deliveryZone = exports['qb-target']:AddBoxZone(deliveryTargetID, coords, 1, 1, {
            ...
            options = {
                {
                    type = 'client',
                    event = 'jd-recycling:client:target:dropPackage',
    ...
    if Config.UseTarget then
        pickupZone = exports['qb-target']:AddBoxZone(pickupTargetID, targetCoords, 4, 1.5, {
            ...
            options = {
                {
                    type = 'client',
                    event = 'jd-recycling:client:target:pickupPackage',
...
RegisterNetEvent('jd-recycling:client:target:enterLocation', function()
    EnterLocation()
end)

RegisterNetEvent('jd-recycling:client:target:exitLocation', function()
    ExitLocation()
end)

RegisterNetEvent('jd-recycling:client:target:toggleDuty', function()
    onDuty = not onDuty
    if onDuty then
...
RegisterNetEvent('jd-recycling:client:target:pickupPackage', function()
...
RegisterNetEvent('jd-recycling:client:target:dropPackage', function()
        ...
        while true do
            ...
            if isInsideEntranceZone then
                ...
                if IsControlJustReleased(0, 38) then
                    ...
                    Wait(500)
                    TriggerEvent('jd-recycling:client:target:enterLocation')
                    exports['qb-core']:HideText()
                end
            end
            ...
            if isInsideExitZone then
                ...
                if IsControlJustReleased(0, 38) then
                    exports['qb-core']:KeyPressed()
                    Wait(500)
                    TriggerEvent('jd-recycling:client:target:exitLocation')
                    exports['qb-core']:HideText()
                end
            end
            ...
            if isInsideDutyZone then
                ...
                if IsControlJustReleased(0, 38) then
                    exports['qb-core']:KeyPressed()
                    Wait(500)
                    TriggerEvent('jd-recycling:client:target:toggleDuty')
                    exports['qb-core']:HideText()
                end
            end
            ...
            if onDuty then
                if isInsidePickupZone and not carryPackage then
                    ...
                    if IsControlJustReleased(0, 38) then
                        exports['qb-core']:KeyPressed()
                        Wait(500)
                        TriggerEvent('jd-recycling:client:target:pickupPackage')
                        exports['qb-core']:HideText()
                    end
                ...
                if isInsideDeliveryZone and carryPackage then
                    ...
                    if IsControlJustReleased(0, 38) then
                        exports['qb-core']:KeyPressed()
                        Wait(500)
                        TriggerEvent('jd-recycling:client:target:dropPackage')
                        exports['qb-core']:HideText()
                    end
                end
            end
