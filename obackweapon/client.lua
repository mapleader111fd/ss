local curWeapon = nil
local QBCore = exports['qb-core']:GetCoreObject() -- Jabata
...
local Weapons = {
    ...
    [`WEAPON_KATANA_2`] = { object = `w_me_katana_2`, item = 'WEAPON_KATANA_2', rot = vector3(0,300,0)},
    [`WEAPON_DRAGON_KATANA_RED`] = { object = `w_me_dragon_katana_sheathed_red`, item = 'WEAPON_DRAGON_KATANA_RED', rot = vector3(0,300,0)},
    [`WEAPON_DRAGON_KATANA_BLUE`] = { object = `w_me_dragon_katana_sheathed_blue`, item = 'WEAPON_DRAGON_KATANA_BLUE', rot = vector3(0,300,0)},
    [`WEAPON_DRAGON_KATANA_GREEN`] = { object = `w_me_dragon_katana_sheathed_green`, item = 'WEAPON_DRAGON_KATANA_GREEN', rot = vector3(0,300,0)},
    [`WEAPON_DRAGON_KATANA_PURPLE`] = { object = `w_me_dragon_katana_sheathed_purple`, item = 'WEAPON_DRAGON_KATANA_PURPLE', rot = vector3(0,300,0)},
    [`WEAPON_DRAGON_KATANA_YELLOW`] = { object = `w_me_dragon_katana_sheathed_yellow`, item = 'WEAPON_DRAGON_KATANA_YELLOW', rot = vector3(0,300,0)},
    [`WEAPON_KATANA_2_TRIAD`] = { object = `w_me_katana_2_saya_triad`, item = 'WEAPON_KATANA_2_TRIAD', rot = vector3(0,300,0)},
    ...
    -- MELEE
    [`WEAPON_BAT`] = {object = `w_me_bat`, item = 'WEAPON_BAT', rot = vector3(0,310,0)}, 
...
local slots = {
    [1] = {
        pos = vec3(0.25, -0.15, -0.12), -- Center Of Back
        entity = nil,
        hash = nil,
        wep = nil
    },
    [2] = {
        pos = vec3(0.25, -0.15, -0.12), -- Chest (front)
        entity = nil,
        hash = nil,
        wep = nil
    },
    [3] = {
        pos = vec3(0.25, -0.15, -0.12), -- Center of Back, on top of other gun
        entity = nil,
        hash = nil,
        wep = nil
    },
    [4] = {
        pos = vec3(0.25, -0.15, -0.12), -- Chest (front) on top of other front gun
        hash = nil,
        wep = nil
    },
}
