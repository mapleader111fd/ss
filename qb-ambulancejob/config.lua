...
Config.ReviveInterval = 480                                  -- How long the timer is for players to revive a player in laststand
Config.MinimumRevive = 480                                   -- How long the timer is for players to revive a player in laststand
...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        vector3(-675.48, 330.33, 80.92),
        vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ['duty'] = {
        vector3(-667.72, 334.31, 81.96),
        vector3(-254.88, 6324.5, 32.58), -- paleto
    },
    ['vehicle'] = {
        vector4(-699.20, 311.04, 82.95, 179.27),
        vector4(-234.28, 6329.16, 32.15, 222.5), -- paleto
    },
    ['helicopter'] = {
        vector4(-646.46, 318.87, 141.96, 76.01),
        vector4(-475.43, 5988.353, 31.716, 31.34), -- paleto
    },
    ['roof'] = {
        vector4(-674.40, 323.92, 140.12, 165.24),
    },
    ['main'] = {
        vector3(-683.54, 326.79, 83.08),
    },
    ['stash'] = {
        vector3(-668.22, 328.46, 81.90),
    },
    ['beds'] = {
        { coords = vector4(-662.24, 360.09, 83.76, 177.79),    taken = false, model = 1631638868 },
        { coords = vector4(-659.24, 359.49, 83.75, 173.95),  taken = false, model = 1631638868 },
        { coords = vector4(-656.18, 359.41, 83.76, 171.40),   taken = false, model = 2117668672 },
        { coords = vector4(-653.07, 359.16, 83.76, 172.59),    taken = false, model = 2117668672 },
        -- { coords = vector4(317.71, -585.37, 44.20, 345.04),   taken = false, model = 2117668672 },
        -- { coords = vector4(309.38, -577.31, 44.20, 158.98),  taken = false, model = -1091386327 },
        -- { coords = vector4(307.85, -581.83, 44.20, 335.83),  taken = false, model = -1091386327 },
        -- { coords = vector4(311.03, -583.07, 44.20, 340.98),  taken = false, model = -1091386327 },
        --- paleto
    ...
    ['hospital'] = {
        {
            ['name'] = "Eclipse Hospital",
            ['location'] = vector3(-674.84, 325.49, 83.08),
            ['beds'] = {
                { coords = vector4(-662.24, 360.09, 83.76, 177.79),    taken = false, model = 1631638868 },
                { coords = vector4(-659.24, 359.49, 83.75, 173.95),  taken = false, model = 1631638868 },
                { coords = vector4(-656.18, 359.41, 83.76, 171.40),   taken = false, model = 2117668672 },
    ...
    ['stations'] = {
        { label = "Eclipse Hospital", coords = vector3(-674.84, 325.49, 83.08) }
    }
}
